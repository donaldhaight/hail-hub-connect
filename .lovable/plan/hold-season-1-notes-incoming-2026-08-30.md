# Hold — Season 1 Notes Incoming

## What we resolved in this session

- **Season 1 shape:** a campaign arc that reveals a standing operating rhythm.
...
6–8 pages of notes covering the complete Season, including:

1. The legacy object list (Groups, Roles, Leads, Opportunities, Estimates, Work Orders, Jobs, Invoices, Payments, Commissions, or whatever the actual vocabulary is).
...
Hold all build and manuscript work until the notes arrive. Once they land, synthesize them into a concrete Season 1 demo plan with:

- The exact objects and fields we need in the database.
